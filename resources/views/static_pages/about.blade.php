    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <ul id="pageNavUL" class="list-inline">
            <li class="active"><a style="cursor:pointer">公司介紹</a></li>
            <li ><a style="cursor:pointer">經營理念</a></li>
            <li ><a style="cursor:pointer">未來願景</a></li>
            <li ><a style="cursor:pointer">關係企業</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="container PT-2Column">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 adContentWord">
        ...
        <br>
        <br>
        <a  style="cursor:pointer" type="button" class="btn themeDarkerStyleBtn">了解我們的經營理念</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container PT-2Column">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 adContentWord">
        ...
        <br>
        <br>
        <a  style="cursor:pointer" type="button" class="btn themeDarkerStyleBtn">了解我們的未來願景</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container PT-2Column">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 adContentWord">
        ...
        <br>
        <br>
        <a  style="cursor:pointer" type="button" class="btn themeDarkerStyleBtn">了解我們的關係企業</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container PT-2Column">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 adContentWord">
        ...
        <br>
        <br>
        <a  style="cursor:pointer" type="button" class="btn themeDarkerStyleBtn">返回公司簡介</a>
      </div>
    </div>
  </div>
</section>
